...
#define LEFT_ENCODER_POLAR      -1
#define RIGHT_ENCODER_POLAR     1
...
#define WHEEL_DIAMETER          0.08387 // diameter of wheel in meters
#define WHEEL_BASE              0.14622  // wheel separation distance in meters
